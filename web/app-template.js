          ...
          <div class="layout" :class="{ 'layout-help': currentView === 'help' }">
            <aside class="sidebar" :style="{ width: sidebarWidth + 'px' }">
              <div class="sidebar-content">
                ...
                <div class="card sidebarUserCard">
                  <div class="cardTitle">当前用户</div>
                  <div class="sidebarUserName">{{ authUser.display_name || authUser.username }}</div>
                  <div class="sidebarUserMeta">@{{ authUser.username }}</div>
                  <button class="btn btn-secondary sidebarLogoutBtn" @click="logout()">退出登录</button>
                </div>
